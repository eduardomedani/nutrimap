-- ===========================================================================
-- DESFAZER db/multiusuario_etapa4b_rpc.sql
-- ---------------------------------------------------------------------------
-- Repoe as duas RPCs COM o TETO TEMPORARIO — o estado anterior a Etapa 4B.
-- 100% re-executavel.
--
-- GERADO A PARTIR DE db/comercial_periodo_da_cobranca.sql, sem nenhuma
-- transformacao: as funcoes aqui sao byte a byte as que aquele arquivo define.
--
-- ===========================================================================
-- ORDEM DO ROLLBACK: ESTE ARQUIVO VEM ANTES
-- ---------------------------------------------------------------------------
-- Rode este e SO DEPOIS db/multiusuario_etapa4b_rls_desfazer.sql.
--
-- As funcoes sem teto contam com a RLS da 4B para nao concederem demais.
-- Devolver a RLS antiga primeiro deixaria, entre um comando e outro, funcoes
-- SECURITY DEFINER mais permissivas que as policies em volta — e SECURITY
-- DEFINER passa por cima de policy.
--
-- Repondo o teto primeiro, a janela nao existe: ele reduz as duas funcoes ao
-- proprietario, que e exatamente o que a RLS antiga tambem faz.
-- ===========================================================================
...
--   com_teto = 2        o teto voltou nas duas funcoes
